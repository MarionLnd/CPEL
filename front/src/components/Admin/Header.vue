    ...
    <nav class="navbar navbar-expand-md navbar-light bg-header fixed-top">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item">
                    <router-link class="nav-link" to="admin/tableau-de-bord">Tableau de bord<span class="sr-only">(current)</span></router-link>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <router-link class="nav-link text-white" to="/profil">Gérer</router-link>
                </li>
                <li class="nav-item">
                    <a class="nav-link disabled text-white" href="#">Déconnexion</a>
                </li>
            </ul>
        </div>
    </nav>
